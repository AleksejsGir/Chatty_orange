...
urlpatterns = [
    ...
    path('comments/<int:parent_id>/reply/', views.comment_reply, name='comment-reply'),  # Убедитесь, что этот путь активен
    path('comments/<int:comment_id>/toggle-reaction/', views.toggle_reaction, name='toggle_reaction'),
    path('comments/<int:pk>/react/', views.comment_react, name='comment-react'),
    path('comments/update/<int:pk>/', views.comment_update, name='comment-update'),
